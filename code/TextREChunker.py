...
class TextREChunker:
    ...
    def protect_pivot_verb(self,tagged):
        ...
        _TextA_arr=map(lambda filename_dict:filename_dict.split('/')[1],cksum_cleanedf)

        if len(filter(lambda filename_dict:filename_dict in info_arr,_TextA_arr))!=1:
            return tagged
    ...
    def postchunk_px(self,chunked):
        ...
        _TextA_arr=map(lambda filename_dict:filename_dict[1],info_dict)
        tmp_arr=" (IN )?IN \(NX(.+?) NX\) "
        ...
        while awk1:
            ...
            if groupnames_str:
                ...
                tagged_str=(info_str,len(_TextA_arr)-cleaned_arr)
                mores=file1[tagged_str[0]:tagged_str[1]]
                popd_arr=_TextA_arr[tagged_str[0]:tagged_str[1]]
                ...
                for stripped_dict in range(len(file1)):
                    ...
                    if stripped_dict in range(tagged_str[0],tagged_str[1]):
                        ...
                        _TextA_arr[stripped_dict]=stripped_str
        chunked=' '.join(map(lambda filename_dict:file1[filename_dict]+'/'+_TextA_arr[filename_dict],range(len(file1))))
            ...
            if groupnames_str:
                ...
                for stripped_dict in range(len(file1)):
                    ...
                    if stripped_dict in range(tagged_str[0],tagged_str[1]):
                        file1[stripped_dict]='bar'
                        _TextA_arr[stripped_dict]=stripped_str
        cd_str=' '.join(map(lambda filename_dict:file1[filename_dict]+'/'+_TextA_arr[filename_dict],range(len(file1))))
        return cd_str
...
if __name__=="__main__":
    ...
    m=TextREChunker()
    print '*************************\n'
    print 'TextREChunker v'+__version__
