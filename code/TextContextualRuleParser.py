...
class TextContextualRuleParser:
    ...
    def __init__(self):
        self.contextualrules_filename=TextUtils.TextUtils().find_file(self.contextualrules_filename)
    ...
    def apply_rules_to_all_words(self,text_arr,depth_or_breadth_first_firing='depth'):
        ...
        while (inputs):
            ...
            for the_parser_str in range(len(text_arr)):
                b_arr=hostnames_arr(text_arr,the_parser_str,_TextA_arr)
